...
public class WidgetExperiments implements EntryPoint {
	...
	private static class Proposition extends TreeItem implements ClickHandler {
		...
		// TODO: fix formating ... compress visual space
		// TODO: return creates new prop?
		...
		public void addArgument(String labelText) {
			TreeItem labelTreeItem = new TreeItem( labelText );
			labelTreeItem.addItem(new Proposition());
			this.addItem( labelTreeItem );
			labelTreeItem.setState(true);
		}
	}
